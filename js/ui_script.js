...
function addLineEditor(width,height,shiftX,shiftY,color){
	...
	for(let i=1;i<col_amount;i++)col_text+="<option value=\""+i+"\">"+i+" col</option>\n";

	$("#edit_lines").append("<div class=\"flexed_block plot_line\">\n" +
"            <div>\n" +
"                <span class=\"desc_above\">Selection</span>\n" +
"                <input type=\"button\" class=\"r_use input_type\" value='Draw inside'>\n" +
"            </div>\n" +
"            <div>\n" +
"                <span class=\"desc_above\">Call X</span>\n" +
...
"            </div>\n" +
"            <div>\n" +
"                <span class=\"desc_above\">Col Y</span>\n" +
